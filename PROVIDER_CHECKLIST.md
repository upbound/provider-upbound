...
The [provider-upbound](https://github.com/upbound/provider-upbound) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/upbound/provider-upbound/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/upbound/provider-upbound/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/upbound/provider-upbound/blob/main/hack/boilerplate.go.txt](https://github.com/upbound/provider-upbound/blob/main/hack/boilerplate.go.txt)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/upbound/provider-upbound/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/upbound/provider-upbound/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue upbounds (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/upbound/provider-upbound/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Upbounds: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/upbound/provider-upbound/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
